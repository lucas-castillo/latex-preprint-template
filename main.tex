...
\documentclass[9pt,lineno]{lapreprint}
% Choose between "biorxiv", "medrxiv", "arxiv" "psyarxiv" and "chemrxiv". Otherwise defaults "Preprint".
...
\author[ \orcidlink{0000-0003-0274-0777} 1 \Letter]{Lucas Castillo}
\author[ \orcidlink{0000-0003-0442-4372} 1]{Adam N. Sanborn}

% Affiliations
\affil[1]{University of Warwick, United Kingdom}
%\affil[2]{University of Somewhere}

% Other metadata. Feel free to add your own
\metadata[]{\Letter\hspace{.5ex} For correspondence}{\href{mailto:castillo.lucas@protonmail.com}{castillo.lucas@protonmail.com}}
...
\metadata[]{Present address}{Department of Psychology, University of Warwick, Coventry CV4 7AL, United Kingdom}
...
\leadauthor{Castillo \& Sanborn}
\shorttitle{A Preprint Template for \LaTeX}

 % Edit date in footer (if needed)
\date{\today}
